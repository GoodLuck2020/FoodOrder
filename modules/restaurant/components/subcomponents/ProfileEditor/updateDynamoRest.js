...
export function updateDynamoRestaurant(incomingData) {
  
  updateRestaurantProfile(incomingData);
  async function updateRestaurantProfile(dataToDynamo) {
    const info = await Auth.currentUserInfo();
    const body = {...dataToDynamo,RestaurantId:info.username,restaurant:true};
